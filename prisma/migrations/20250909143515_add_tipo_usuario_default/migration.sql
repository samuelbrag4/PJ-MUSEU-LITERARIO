...
INSERT INTO "new_Usuario" ("email", "entrouEm", "foto", "id", "idade", "livroDestaqueId", "nascimento", "nome", "nomeUsuario", "senha") SELECT "email", "entrouEm", "foto", "id", "idade", "livroDestaqueId", "nascimento", "nome", "nomeUsuario", "senha" FROM "Usuario";
DROP TABLE "Usuario";
