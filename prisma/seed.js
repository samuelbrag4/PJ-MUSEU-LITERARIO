...
async function main() {
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 42.50,
			imagem: "https://ui-avatars.com/api/?name=A+Hora+da+Estrela&background=9370DB&color=FFF&size=400",
			genero: "Romance",
			dificuldade: "DIFICIL",
			temAdaptacao: true,
			numeroPaginas: 192
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 32.90,
			imagem: "https://ui-avatars.com/api/?name=Iracema&background=228B22&color=FFF&size=400",
			genero: "Romance",
			dificuldade: "MEDIA",
			temAdaptacao: true,
			numeroPaginas: 144
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 35.90,
			imagem: "https://ui-avatars.com/api/?name=O+Guarani&background=8B4513&color=FFF&size=400",
			genero: "Romance",
			dificuldade: "MEDIA",
			temAdaptacao: true,
			numeroPaginas: 432
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 38.90,
			imagem: "https://ui-avatars.com/api/?name=Triste+Fim+de+Policarpo+Quaresma&background=CD853F&color=FFF&size=400",
			genero: "Drama",
			dificuldade: "MEDIA",
			temAdaptacao: true,
			numeroPaginas: 256
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 36.90,
			imagem: "https://ui-avatars.com/api/?name=Clara+dos+Anjos&background=DDA0DD&color=FFF&size=400",
			genero: "Drama",
			dificuldade: "MEDIA",
			temAdaptacao: false,
			numeroPaginas: 288
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 34.90,
			imagem: "https://ui-avatars.com/api/?name=O+Quinze&background=FF6347&color=FFF&size=400",
			genero: "Drama",
			dificuldade: "FACIL",
			temAdaptacao: true,
			numeroPaginas: 192
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 42.90,
			imagem: "https://ui-avatars.com/api/?name=Memórias+Póstumas&background=4B0082&color=FFF&size=400",
			genero: "Drama",
			dificuldade: "MEDIA",
			temAdaptacao: false,
			numeroPaginas: 384
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 33.90,
			imagem: "https://ui-avatars.com/api/?name=Quincas+Borba&background=8B0000&color=FFF&size=400",
			genero: "Romance",
			dificuldade: "MEDIA",
			temAdaptacao: true,
			numeroPaginas: 224
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 39.90,
			imagem: "https://ui-avatars.com/api/?name=Helena&background=FF1493&color=FFF&size=400",
			genero: "Drama",
			dificuldade: "DIFICIL",
			temAdaptacao: false,
			numeroPaginas: 208
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 46.90,
			imagem: "https://ui-avatars.com/api/?name=A+Mão+e+a+Luva&background=FFD700&color=000&size=400",
			genero: "Drama",
			dificuldade: "DIFICIL",
			temAdaptacao: false,
			numeroPaginas: 192
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 41.90,
			imagem: "https://ui-avatars.com/api/?name=Olhos+d'Água&background=4169E1&color=FFF&size=400",
			genero: "Contos",
			dificuldade: "MEDIA",
			temAdaptacao: false,
			numeroPaginas: 136
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 49.90,
			imagem: "https://ui-avatars.com/api/?name=Escrava+Isaura&background=20B2AA&color=FFF&size=400",
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 52.90,
			imagem: "https://ui-avatars.com/api/?name=Canções+de+Escárnio&background=B22222&color=FFF&size=400",
			genero: "Literatura Contemporânea",
			dificuldade: "MEDIA",
			temAdaptacao: false,
			numeroPaginas: 288
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 56.90,
			imagem: "https://ui-avatars.com/api/?name=Insubmissas+lágrimas&background=9370DB&color=FFF&size=400",
			genero: "Literatura Contemporânea",
			dificuldade: "MEDIA",
			temAdaptacao: true,
			numeroPaginas: 320
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 44.90,
			imagem: "https://ui-avatars.com/api/?name=Becos+da+Memória&background=2F4F4F&color=FFF&size=400",
			genero: "Contos",
			dificuldade: "MEDIA",
			temAdaptacao: false,
			numeroPaginas: 116
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 41.90,
			imagem: "https://ui-avatars.com/api/?name=Ponciá+Vicêncio&background=8B4513&color=FFF&size=400",
			genero: "Contos",
			dificuldade: "MEDIA",
			temAdaptacao: false,
			numeroPaginas: 118
	...
	await prisma.livro.create({
		data: {
			...
			mediaPreco: 38.90,
			imagem: "https://ui-avatars.com/api/?name=Histórias+de+leves+enganos&background=DC143C&color=FFF&size=400",
			genero: "Contos",
			dificuldade: "MEDIA",
			temAdaptacao: false,
			numeroPaginas: 128
